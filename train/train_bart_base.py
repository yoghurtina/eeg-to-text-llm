...
def train_model(dataloaders, device, model, criterion, optimizer, scheduler, num_epochs=1, checkpoint_path_best = './checkpoints/decoding/best/temp_decoding.pt', checkpoint_path_last = './checkpoints/decoding/last/temp_decoding.pt'):
...
if __name__ == '__main__':
    ...
    if model_name == 'BrainTranslator':
        if use_random_init:
            ...
            pretrained = BartForConditionalGeneration.from_pretrained('facebook/bart-base')
        ...
        model = BrainTranslatorNaive(pretrained, in_feature = 105*len(bands_choice), decoder_embedding_size = 768, additional_encoder_nhead=8, additional_encoder_dim_feedforward = 2048)
